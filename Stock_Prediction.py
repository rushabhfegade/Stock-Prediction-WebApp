...
class Stock_Prediction:
    ...
    def Prophet(self, period=None):
        ...
        if submitted: 
            ...
            with st.beta_expander(f"{self.company_name} {selected_stock_option} Stock Price Forecast Plot"):
            ...
            with st.beta_expander(f"{self.company_name} {selected_stock_option} Stock Price Time Series Components"):
            ...
            with st.beta_expander(f"{self.company_name} {selected_stock_option} Forecasted Stock Price Data"):
            ...
            with st.beta_expander(f"{self.company_name} {selected_stock_option} Forecasted Diagnostics"):
                pass

            with st.beta_expander(f"Download {self.company_name} {selected_stock_option} Stock Price Forecasting Model"):
